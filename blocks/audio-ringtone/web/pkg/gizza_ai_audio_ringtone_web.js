/* @ts-self-types="./gizza_ai_audio_ringtone_web.d.ts" */
 ...
 * @returns {any}
 */
export function build_argv(start, end, fade_in, fade_out, normalize, format, in_name) {
    const ptr0 = passStringToWasm0(normalize, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(format, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(in_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.build_argv(start, end, fade_in, fade_out, ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[2]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_audio_ringtone_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_audio_ringtone_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
