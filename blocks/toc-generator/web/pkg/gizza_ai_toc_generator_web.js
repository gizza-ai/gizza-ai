/* @ts-self-types="./gizza_ai_toc_generator_web.d.ts" */
 ...
 * @returns {string}
 */
export function run(document, input_format, output_format, min_level, max_level, ordered) {
    let deferred8_0;
    let deferred8_1;
    try {
        ...
        const ptr3 = passStringToWasm0(min_level, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passStringToWasm0(max_level, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len4 = WASM_VECTOR_LEN;
        const ptr5 = passStringToWasm0(ordered, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_toc_generator_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_toc_generator_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
