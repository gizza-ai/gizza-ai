...
export function run(url: string, source: string, medium: string, campaign: string, term: string, content: string, id: string, source_platform: string, creative_format: string, marketing_tactic: string, lowercase: string): string;
