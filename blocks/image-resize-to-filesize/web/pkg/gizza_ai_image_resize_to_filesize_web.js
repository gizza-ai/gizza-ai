/* @ts-self-types="./gizza_ai_image_resize_to_filesize_web.d.ts" */
 ...
 * @param {number} _target_kb
 * @param {string} format
 * @param {number} max_width
 * @param {string} in_name
 * @returns {any}
 */
export function build_argv(_target_kb, format, max_width, in_name) {
    const ptr0 = passStringToWasm0(format, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(in_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.build_argv(_target_kb, ptr0, len0, max_width, ptr1, len1);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function build_attempt(format, quality, max_width, in_name) {
    const ptr0 = passStringToWasm0(format, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(in_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.build_attempt(ptr0, len0, quality, max_width, ptr1, len1);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_image_resize_to_filesize_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_image_resize_to_filesize_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
