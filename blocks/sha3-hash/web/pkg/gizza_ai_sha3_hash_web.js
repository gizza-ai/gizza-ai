/* @ts-self-types="./gizza_ai_sha3_hash_web.d.ts" */

/**
 * Compute the FIPS-202 SHA-3 digest of `text` with the selected variant.
 *
 * The standalone tool page passes every field value as a string:
 * - `text`: the input to hash.
 * - `algorithm`: `"sha3-256"` (blank → sha3-256) / `"sha3-384"` / `"sha3-512"`.
 ...
 * @returns {string}
 */
export function run(text, algorithm, input_encoding, output_format, uppercase) {
    let deferred7_0;
    let deferred7_1;
    try {
        ...
        const ptr2 = passStringToWasm0(input_encoding, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_sha3_hash_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_sha3_hash_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
