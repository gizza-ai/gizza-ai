//! Browser-facing wasm-bindgen wrapper for /tools/sha3-hash/.
//! Compiled with wasm-pack for the standalone /tools/sha3-hash/ page.
...
pub fn run(
    ...
    gizza_ai_sha3_hash_core::hash(text, algorithm, input_encoding, output_format, uppercase)
