...
export function run(password: string, mode: string, salt: string, salt_encoding: string, iterations: string, hash: string, length: string, encoding: string, expected: string): string;
