/* @ts-self-types="./gizza_ai_cron_next_runs_web.d.ts" */
 ...
 * @returns {string}
 */
export function run(expression, after, count, format) {
    let deferred6_0;
    let deferred6_1;
    try {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_cron_next_runs_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_cron_next_runs_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
