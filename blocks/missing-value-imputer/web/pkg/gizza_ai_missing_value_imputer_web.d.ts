...
export function run(input: string, strategy: string, header: string, delimiter: string, columns: string, na_tokens: string, fill_value: string, n_neighbors: string, weights: string): string;
