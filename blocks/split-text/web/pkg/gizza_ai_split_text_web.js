/* @ts-self-types="./gizza_ai_split_text_web.d.ts" */
 ...
 * @returns {string}
 */
export function run(text, delimiter, mode, trim, remove_empty) {
    let deferred7_0;
    let deferred7_1;
    try {
        ...
        const ptr3 = passStringToWasm0(trim, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passStringToWasm0(remove_empty, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_split_text_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_split_text_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
