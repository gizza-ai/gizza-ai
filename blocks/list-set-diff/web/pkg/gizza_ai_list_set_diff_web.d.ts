 ...
 */
export function run(list_a: string, list_b: string, separator: string, ignore_case: string, trim: string, ignore_blank: string, dedupe: string, ignore_leading_zeros: string, sort: string): string;
