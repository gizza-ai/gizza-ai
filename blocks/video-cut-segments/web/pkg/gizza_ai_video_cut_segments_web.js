/* @ts-self-types="./gizza_ai_video_cut_segments_web.d.ts" */
 ...
 * @returns {any}
 */
export function build_argv(segments, mode, in_name) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_video_cut_segments_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_video_cut_segments_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
