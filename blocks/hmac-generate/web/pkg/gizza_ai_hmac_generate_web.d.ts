 ...
 * undecodable input.
 */
export function run(message: string, key: string, algorithm: string, message_encoding: string, key_encoding: string, output_format: string, uppercase: string): string;
