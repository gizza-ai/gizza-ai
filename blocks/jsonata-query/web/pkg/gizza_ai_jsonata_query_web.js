/* @ts-self-types="./gizza_ai_jsonata_query_web.d.ts" */
 ...
 * @returns {string}
 */
export function run(query, json, pretty) {
    let deferred5_0;
    let deferred5_1;
    try {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_jsonata_query_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_jsonata_query_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
