/* @ts-self-types="./gizza_ai_rtf_to_text_web.d.ts" */
 ...
 * @param {string} rtf
 * @param {string} line_breaks
 * @returns {string}
 */
export function run(rtf, line_breaks) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(rtf, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(line_breaks, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_rtf_to_text_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_rtf_to_text_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
