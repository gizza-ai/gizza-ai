...
export function run(filenames: string, mode: string, find: string, replace: string, case_type: string, pattern: string, start: string, padding: string, prefix: string, suffix: string, preserve_extension: string): string;
