/* @ts-self-types="./gizza_ai_email_obfuscator_web.d.ts" */
 ...
 * @param {string} email
 * @param {string} mode
 * @param {string} entity_style
 * @param {string} link
 * @param {string} link_text
 * @returns {string}
 */
export function run(email, mode, entity_style, link, link_text) {
    let deferred7_0;
    let deferred7_1;
    try {
        ...
        const ptr2 = passStringToWasm0(entity_style, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(link, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passStringToWasm0(link_text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_email_obfuscator_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_email_obfuscator_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
