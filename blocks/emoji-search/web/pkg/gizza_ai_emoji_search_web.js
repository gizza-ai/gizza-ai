/* @ts-self-types="./gizza_ai_emoji_search_web.d.ts" */
 ...
 * @param {string} query
 * @param {string} limit
 * @param {string} glyphs_only
 * @returns {string}
 */
export function run(query, limit, glyphs_only) {
    let deferred5_0;
    let deferred5_1;
    try {
        ...
        const ptr2 = passStringToWasm0(glyphs_only, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_emoji_search_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_emoji_search_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
