...
// field inputs, so this adapter reads the uploaded audio file as base64 and
...
export function setup(ctx) {
  ...
  function gatherArgs() {
    return cfg.inputs.map((input) => {
      if (input.source === "file") return selectedBase64;
      return helpers.readField(document.getElementById(input.elementId));
    });
  }
