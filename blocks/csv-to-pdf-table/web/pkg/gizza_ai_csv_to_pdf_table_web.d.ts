...
export function run(data: string, delimiter: string, header: string, title: string, page_size: string, orientation: string, font_size: string, row_banding: string, grid: string): string;
