/* @ts-self-types="./gizza_ai_audio_convert_web.d.ts" */
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_audio_convert_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_audio_convert_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
