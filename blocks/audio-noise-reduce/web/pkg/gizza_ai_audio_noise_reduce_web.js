/* @ts-self-types="./gizza_ai_audio_noise_reduce_web.d.ts" */
 ...
 * @param {string} method
 * @param {string} remove_hum
 * @param {string} format
 * @param {string} in_name
 * @returns {any}
 */
export function build_argv(strength, method, remove_hum, format, in_name) {
    const ptr0 = passStringToWasm0(method, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(remove_hum, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    ...
    const ret = wasm.build_argv(strength, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
    if (ret[2]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_audio_noise_reduce_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_audio_noise_reduce_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
