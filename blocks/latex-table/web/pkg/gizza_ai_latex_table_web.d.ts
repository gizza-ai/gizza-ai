...
export function run(data: string, delimiter: string, style: string, alignment: string, header: string, escape: string, bold_header: string, caption: string, label: string): string;
