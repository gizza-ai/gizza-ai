/* @ts-self-types="./gizza_ai_slugify_web.d.ts" */
 ...
 * @param {string} per_line
 * @returns {string}
 */
export function run(text, separator, lowercase, max_length, per_line) {
    let deferred7_0;
    let deferred7_1;
    try {
        ...
        const ptr2 = passStringToWasm0(lowercase, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(max_length, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passStringToWasm0(per_line, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_slugify_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_slugify_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
