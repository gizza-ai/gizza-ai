...
export function run(data: string, columns: string, delimiter: string, header: string, threshold: string, keep: string, normalize_case: string, normalize_spacing: string, output: string): string;
