/* @ts-self-types="./gizza_ai_tweet_thread_splitter_web.d.ts" */
 ...
 * @param {string} count
 * @param {string} prefer_sentences
 * @returns {string}
 */
export function run(text, limit, numbering, count, prefer_sentences) {
    let deferred7_0;
    let deferred7_1;
    try {
        ...
        const ptr2 = passStringToWasm0(numbering, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(count, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passStringToWasm0(prefer_sentences, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_tweet_thread_splitter_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_tweet_thread_splitter_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
