/* @ts-self-types="./gizza_ai_audio_eq_web.d.ts" */
 ...
 * @returns {any}
 */
export function build_argv(bass, mid, treble, format, in_name) {
    const ptr0 = passStringToWasm0(format, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(in_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.build_argv(bass, mid, treble, ptr0, len0, ptr1, len1);
    if (ret[2]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_audio_eq_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_audio_eq_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
