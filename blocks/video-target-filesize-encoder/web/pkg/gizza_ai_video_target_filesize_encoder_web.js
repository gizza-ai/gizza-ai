/* @ts-self-types="./gizza_ai_video_target_filesize_encoder_web.d.ts" */
 ...
 * @returns {any}
 */
export function build_argv(target_mb, duration_s, audio, scale, in_name) {
    const ptr0 = passStringToWasm0(audio, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    ...
    const ret = wasm.build_argv(target_mb, duration_s, ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[2]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_video_target_filesize_encoder_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_video_target_filesize_encoder_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
