...
export function run(data: string, chart_type: string, x_column: string, y_column: string, title: string, width: string, height: string, color: string, bins: string): string;
