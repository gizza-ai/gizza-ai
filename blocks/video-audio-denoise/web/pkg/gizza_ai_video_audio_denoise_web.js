/* @ts-self-types="./gizza_ai_video_audio_denoise_web.d.ts" */
 ...
 * @returns {any}
 */
export function build_argv(strength, method, remove_hum, in_name) {
    ...
    const ret = wasm.build_argv(strength, ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[2]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_video_audio_denoise_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_video_audio_denoise_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
