/* @ts-self-types="./gizza_ai_video_extract_audio_track_web.d.ts" */
 ...
 * @returns {any}
 */
export function build_argv(container, track, in_name) {
    ...
    const ret = wasm.build_argv(ptr0, len0, track, ptr1, len1);
    if (ret[2]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_video_extract_audio_track_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_video_extract_audio_track_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
