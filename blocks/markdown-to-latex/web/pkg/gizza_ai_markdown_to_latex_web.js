/* @ts-self-types="./gizza_ai_markdown_to_latex_web.d.ts" */
 ...
 * @param {string} full_document
 * @param {string} heading_offset
 * @returns {string}
 */
export function run(markdown, full_document, heading_offset) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(markdown, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(full_document, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(heading_offset, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_markdown_to_latex_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_markdown_to_latex_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
