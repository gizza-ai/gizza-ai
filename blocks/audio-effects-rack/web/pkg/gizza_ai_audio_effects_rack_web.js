/* @ts-self-types="./gizza_ai_audio_effects_rack_web.d.ts" */
 ...
 * @returns {any}
 */
export function build_argv(reverb, echo, chorus, tremolo, compression, format, in_name) {
    const ptr0 = passStringToWasm0(reverb, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(chorus, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    ...
    const ret = wasm.build_argv(ptr0, len0, echo, ptr1, len1, tremolo, ptr2, len2, ptr3, len3, ptr4, len4);
    if (ret[2]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_audio_effects_rack_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_audio_effects_rack_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
