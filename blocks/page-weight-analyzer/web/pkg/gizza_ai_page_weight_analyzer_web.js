/* @ts-self-types="./gizza_ai_page_weight_analyzer_web.d.ts" */
 ...
 * @param {string} html
 * @param {string} output
 * @param {string} list_resources
 * @returns {string}
 */
export function run(html, output, list_resources) {
    let deferred5_0;
    let deferred5_1;
    try {
        ...
        const ptr2 = passStringToWasm0(list_resources, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_page_weight_analyzer_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_page_weight_analyzer_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
