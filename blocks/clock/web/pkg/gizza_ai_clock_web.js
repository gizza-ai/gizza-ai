/* @ts-self-types="./gizza_ai_clock_web.d.ts" */
 ...
 * @param {number} unix_secs
 * @returns {string}
 */
export function format_time(unix_secs) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.format_time(unix_secs);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_clock_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_clock_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
