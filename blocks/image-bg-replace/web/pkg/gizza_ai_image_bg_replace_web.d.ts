 ...
 */
export function build_argv(key_color: string, similarity: number, blend: number, bg_type: string, bg_color: string, bg_color2: string, direction: string, format: string, in_name: string): any;
