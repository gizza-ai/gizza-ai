/* @ts-self-types="./gizza_ai_morse_code_web.d.ts" */
 ...
 * @returns {string}
 */
export function run(text, direction, letter_sep, word_sep) {
    let deferred6_0;
    let deferred6_1;
    try {
        ...
        const ptr2 = passStringToWasm0(letter_sep, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(word_sep, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_morse_code_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_morse_code_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
