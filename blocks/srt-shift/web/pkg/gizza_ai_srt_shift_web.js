/* @ts-self-types="./gizza_ai_srt_shift_web.d.ts" */
 ...
 * @returns {string}
 */
export function run(srt, offset, unit) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(srt, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_srt_shift_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_srt_shift_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
