//! Browser-facing wasm-bindgen wrapper for /tools/sha256-hash/.
//! Compiled with wasm-pack for the standalone /tools/sha256-hash/ page.
...
pub fn run(
    ...
    gizza_ai_sha256_hash_core::hash(text, input_encoding, output_format, uppercase)
