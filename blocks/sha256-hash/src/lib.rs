//! gizza-ai/sha256-hash — chat skill block on the shared tool abstraction.
//!
//! Computes the SHA-256 (SHA-2) digest of input text. The text can be
...
//! (RustCrypto `sha2`) → runs on ALL backends including the chat Service Worker.
...
fn descriptor() -> ToolDescriptor {
    ToolDescriptor::new(Input::None)
        .param(
            Param::string("text")
                .required()
                .describe("The text to hash with SHA-256."),
        )
        .param(
        ...
        .param(
            Param::enumv("output_format", ["hex", "base64"])
                .default("hex")
                .describe("Digest representation. 'hex' (default) is 64 lowercase hex chars; 'base64' is standard base64 (44 chars)."),
        )
        .param(
    ...
    fn schema_json_matches_authored_chat_schema() {
        let authored: serde_json::Value = serde_json::from_str(
            r#"{
                "type": "object",
                "properties": {
                    "text": { "type": "string", "description": "The text to hash with SHA-256." },
                    ...
                    "output_format": { "type": "string", "enum": ["hex", "base64"], "default": "hex", "description": "Digest representation. 'hex' (default) is 64 lowercase hex chars; 'base64' is standard base64 (44 chars)." },
