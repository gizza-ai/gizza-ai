/* @ts-self-types="./gizza_ai_rsa_verify_web.d.ts" */
 ...
 * @returns {string}
 */
export function run(message, signature, public_key, scheme, hash) {
    let deferred7_0;
    let deferred7_1;
    try {
        ...
        const ptr4 = passStringToWasm0(hash, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_rsa_verify_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_rsa_verify_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
