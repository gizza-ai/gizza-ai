/* @ts-self-types="./gizza_ai_email_normalizer_web.d.ts" */
 ...
 * @param {string} email
 * @param {string} lowercase_local
 * @returns {string}
 */
export function run(email, lowercase_local) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(email, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(lowercase_local, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_email_normalizer_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_email_normalizer_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
