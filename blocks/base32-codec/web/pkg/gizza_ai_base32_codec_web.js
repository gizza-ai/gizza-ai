/* @ts-self-types="./gizza_ai_base32_codec_web.d.ts" */
 ...
 * @returns {string}
 */
export function run(input, mode, variant, format, lowercase, padding) {
    let deferred8_0;
    let deferred8_1;
    try {
        ...
        const ptr4 = passStringToWasm0(lowercase, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len4 = WASM_VECTOR_LEN;
        const ptr5 = passStringToWasm0(padding, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_base32_codec_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_base32_codec_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
