/* @ts-self-types="./gizza_ai_css_autoprefixer_web.d.ts" */
 ...
 * @returns {string}
 */
export function run(css, dedup) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(css, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(dedup, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gizza_ai_css_autoprefixer_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gizza_ai_css_autoprefixer_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
